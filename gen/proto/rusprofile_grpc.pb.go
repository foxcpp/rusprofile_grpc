...
type RusprofileClient interface {
	// Query retrieves company information from rusprofile.ru site using its INN number.
...
func (c *rusprofileClient) Query(ctx context.Context, in *QueryData, opts ...grpc.CallOption) (*QueryResult, error) {
	out := new(QueryResult)
	err := c.cc.Invoke(ctx, "/rusprofile_grpc.Rusprofile/Query", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Rusprofile_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rusprofile_grpc.Rusprofile/Query",
	}
...
var Rusprofile_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rusprofile_grpc.Rusprofile",
